...
urlpatterns = [
    ...
    # (Optional) AI Analysis is available via web session endpoints (/ai/*)
    # Static Suppression
...
if settings.API_ONLY == '0':
    if settings.PORTAL_ONLY:
        # Standalone portal mode: hide legacy MobSF web UI routes.
        urlpatterns.extend([
            re_path(r'^$', ai_portal.ai_portal, name='home'),
            re_path(r'^ai/$', ai_portal.ai_portal, name='ai_portal'),
            re_path(r'^ai/scan/$', ai_endpoints.ai_scan, name='ai_scan'),
            re_path(r'^ai/report_json/$', ai_endpoints.ai_report_json, name='ai_report_json'),
            re_path(r'^ai/tasks/$', ai_endpoints.ai_tasks, name='ai_tasks'),
            re_path(r'^ai/status/$', ai_endpoints.ai_status, name='ai_status'),
            re_path(r'^ai/recent_scans/$', ai_endpoints.ai_recent_scans, name='ai_recent_scans'),
            re_path(r'^ai/analyze/$', ai_endpoints.ai_analyze, name='ai_analyze'),
            re_path(r'^ai/stream/$', ai_endpoints.ai_stream, name='ai_stream'),
            re_path(r'^ai/result/$', ai_endpoints.ai_result, name='ai_result'),
            re_path(fr'^ai/download/{checksum_regex}/$', ai_endpoints.ai_download, name='ai_download'),
            # Minimal MobSF endpoints used by the portal.
            re_path(r'^upload/$', home.Upload.as_view, name='upload'),
            re_path(fr'^download_binary/{checksum_regex}/$', home.download_binary, name='download_binary'),
            re_path(fr'^pdf/{checksum_regex}/$', pdf.pdf, name='pdf'),
            # Allow viewing legacy HTML reports directly (not embedded).
        ...
        urlpatterns.extend([
            ...
            re_path(r'^upload/$', home.Upload.as_view, name='upload'),
            # AI Portal (modern integrated UI)
            re_path(r'^ai/$', ai_portal.ai_portal, name='ai_portal'),
            re_path(r'^ai/scan/$', ai_endpoints.ai_scan, name='ai_scan'),
            re_path(r'^ai/report_json/$', ai_endpoints.ai_report_json, name='ai_report_json'),
            re_path(r'^ai/tasks/$', ai_endpoints.ai_tasks, name='ai_tasks'),
