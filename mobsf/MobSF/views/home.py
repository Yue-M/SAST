...
def delete_scan(request, api=False):
    ...
    try:
        ...
        # Delete cached AI analysis for this scan (if any)
        mobsf_home = getattr(settings, 'MOBSF_HOME', settings.BASE_DIR)
        ai_cache_file = os.path.join(mobsf_home, 'ai_reports', f'{md5_hash}.json')
