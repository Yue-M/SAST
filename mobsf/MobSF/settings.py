...
# AI Portal only mode
# Set MOBSF_PORTAL_ONLY to 1 to hide legacy web UI routes and expose only
# the standalone AI Portal and the minimal endpoints it needs.
PORTAL_ONLY = os.getenv('MOBSF_PORTAL_ONLY', '0') == '1'
...
MIDDLEWARE = (
    ...
    'mobsf.MobSF.middleware.PortalOnlyMiddleware',
        ...
        'OPTIONS':
            {
                ...
                'context_processors': [
                    ...
                    'mobsf.MobSF.context_processors.portal_flags',
                ],
            },
    },
]
...
LOGIN_URL = 'login'
LOGOUT_REDIRECT_URL = '/ai/' if PORTAL_ONLY else '/'
...
if CONFIG_HOME:
    ...
    JADX_PATH = 'G:\\privite item\\Mobile-Security-Framework-MobSF-master\\jadx\\bin\\jadx.bat'
